                ...
                <div class="card border-0 shadow-sm" style="border-radius: 12px;">
                    <div class="card-body" style="padding: 24px;">
                        ...
                        <div class="d-flex justify-content-start align-items-center mt-4">
                            <a id="continueShoppingBtn" href="{{ route('home') }}" class="btn btn-outline-secondary btn-continue" style="border-radius: 8px; font-weight: 600; padding: 10px 20px;">
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm card-summary" style="border-radius: 12px;">
                    <div class="card-body">
                        ...
                        <a id="checkoutSummaryBtn" href="{{ Auth::check() ? route('checkout.index') : '#' }}" class="btn btn-success w-100" @if(!Auth::check()) onclick="event.preventDefault(); showLoginModal();" @endif style="border-radius: 8px; font-weight: 600; padding: 12px; background: linear-gradient(135deg, #1565c0 0%, #0d47a1 100%); border: none; box-shadow: 0 4px 12px rgba(13, 71, 161, 0.2); transition: all 0.3s ease;">
